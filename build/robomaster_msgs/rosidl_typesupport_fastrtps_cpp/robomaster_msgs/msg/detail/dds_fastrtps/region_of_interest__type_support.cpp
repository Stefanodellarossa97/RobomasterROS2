...
#include "robomaster_msgs/msg/detail/region_of_interest__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robomaster_msgs::msg::RegionOfInterest & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robomaster_msgs::msg::RegionOfInterest & ros_message)
{
  // Member: x_offset
  cdr >> ros_message.x_offset;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robomaster_msgs::msg::RegionOfInterest;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robomaster_msgs::msg::RegionOfInterest *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robomaster_msgs::msg::RegionOfInterest *>(
    untyped_ros_message);
...
get_message_type_support_handle<robomaster_msgs::msg::RegionOfInterest>()
{
  return &robomaster_msgs::msg::typesupport_fastrtps_cpp::_RegionOfInterest__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robomaster_msgs, msg, RegionOfInterest)() {
  return &robomaster_msgs::msg::typesupport_fastrtps_cpp::_RegionOfInterest__handle;
}
