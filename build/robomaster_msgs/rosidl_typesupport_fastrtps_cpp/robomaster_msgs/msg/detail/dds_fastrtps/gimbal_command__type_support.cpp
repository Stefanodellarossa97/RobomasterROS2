...
#include "robomaster_msgs/msg/detail/gimbal_command__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robomaster_msgs::msg::GimbalCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robomaster_msgs::msg::GimbalCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robomaster_msgs::msg::GimbalCommand *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GimbalCommand__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const robomaster_msgs::msg::GimbalCommand *>(
...
static size_t _GimbalCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GimbalCommand(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GimbalCommand__callbacks = {
  "robomaster_msgs::msg",
  "GimbalCommand",
...
static rosidl_message_type_support_t _GimbalCommand__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GimbalCommand__callbacks,
...
{
  return &robomaster_msgs::msg::typesupport_fastrtps_cpp::_GimbalCommand__handle;
}
