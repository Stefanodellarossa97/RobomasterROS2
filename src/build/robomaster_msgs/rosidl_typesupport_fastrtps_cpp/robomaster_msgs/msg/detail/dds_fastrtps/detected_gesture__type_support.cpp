...
#include "robomaster_msgs/msg/detail/detected_gesture__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robomaster_msgs::msg::DetectedGesture & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robomaster_msgs::msg::DetectedGesture & ros_message)
{
  // Member: roi
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robomaster_msgs::msg::DetectedGesture;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robomaster_msgs::msg::DetectedGesture *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robomaster_msgs::msg::DetectedGesture *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _DetectedGesture__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const robomaster_msgs::msg::DetectedGesture *>(
...
static size_t _DetectedGesture__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_DetectedGesture(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _DetectedGesture__callbacks = {
  "robomaster_msgs::msg",
  "DetectedGesture",
...
static rosidl_message_type_support_t _DetectedGesture__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_DetectedGesture__callbacks,
...
get_message_type_support_handle<robomaster_msgs::msg::DetectedGesture>()
{
  return &robomaster_msgs::msg::typesupport_fastrtps_cpp::_DetectedGesture__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robomaster_msgs, msg, DetectedGesture)() {
  return &robomaster_msgs::msg::typesupport_fastrtps_cpp::_DetectedGesture__handle;
}
