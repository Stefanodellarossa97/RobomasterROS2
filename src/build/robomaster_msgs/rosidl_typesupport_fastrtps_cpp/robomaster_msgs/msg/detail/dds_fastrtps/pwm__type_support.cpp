...
#include "robomaster_msgs/msg/detail/pwm__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robomaster_msgs::msg::PWM & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: fraction_of_duty_cycle
  {
    cdr << ros_message.fraction_of_duty_cycle;
  }
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robomaster_msgs::msg::PWM & ros_message)
{
  // Member: fraction_of_duty_cycle
  {
    cdr >> ros_message.fraction_of_duty_cycle;
  ...
  size_t current_alignment)
{
  ...
  {
    size_t array_size = 6;
    size_t item_size = sizeof(ros_message.fraction_of_duty_cycle[0]);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robomaster_msgs::msg::PWM;
    is_plain =
      (
      offsetof(DataType, fraction_of_duty_cycle) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const robomaster_msgs::msg::PWM *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robomaster_msgs::msg::PWM *>(
    untyped_ros_message);
...
{
  return &robomaster_msgs::msg::typesupport_fastrtps_cpp::_PWM__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robomaster_msgs, msg, PWM)() {
  return &robomaster_msgs::msg::typesupport_fastrtps_cpp::_PWM__handle;
}
